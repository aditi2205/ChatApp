...
public class server_pers extends javax.swing.JFrame 
{
   ...
   public class ClientHandler implements Runnable	
   {
       ...
       public void run() 
       {
            ...
            try 
            {
                while ((message = reader.readLine()) != null) 
                {
                    ...
                    {
                        tellEveryone((data[0] + ":has disconnected." + ":" + chat+":"+data[3]));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("                 PERSONAL CHAT SERVER");
    ...
    public static void main(String args[]) 
    {
        java.awt.EventQueue.invokeLater(new Runnable() 
        {
            @Override
            public void run() {
                new server_pers().setVisible(true);
            }
        });
    }
    ...
    public void userAdd (String data,String data3)
    {
     ...
     //   ta_chat.append("After " + name + " added. \n");
       /* String[] tempList = new String[(users.size())];
        ...
        {
            message = (token + add+":"+data3);
            tellEveryone(message);
        }
        tellEveryone(done);*/
    }
    
    public void userRemove (String data,String data3)
    {
        //String message, add = ": :Connect", done = "Server: :Done", name = data;
        users.remove(data);
      /*  String[] tempList = new String[(users.size())];
